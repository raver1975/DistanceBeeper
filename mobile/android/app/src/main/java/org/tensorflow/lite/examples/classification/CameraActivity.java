...
//        rotationTextView.setText((int)(100.0*(ClassifierActivity.center-ClassifierActivity.minval)/(ClassifierActivity.maxval - ClassifierActivity.minval))+"");
        rotationTextView.setText((int) (ClassifierActivity.center) + "");
    }
